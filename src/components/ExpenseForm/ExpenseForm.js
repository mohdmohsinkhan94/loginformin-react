  ...
  return (
    <form onSubmit={onSubmitExpense}>
      <div className="form-control">
        ...
        <input
          type="text"
          className={`${stateError.name ? "invalid-input" : "valid-input"}`}
      ...
      <div className="form-control">
        <input
          type="date"
          className={`${stateError.date ? "invalid-input" : "valid-input"}`}
      ...
      <div className="form-control">
        <input
          type="number"
          className={`${stateError.amount ? "invalid-input" : "valid-input"}`}
      ...
      <div className="input-box-2">
        <button type="submit" className="btn" onClick={onExpenseAdded}>
          Add Expense
        </button>
        <Button
